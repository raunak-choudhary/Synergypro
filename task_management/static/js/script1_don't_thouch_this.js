    ...
    if (signupForm) {
        signupForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                // Show welcome modal
                const welcomeModal = document.getElementById('welcomeModal');
                const userName = welcomeModal.querySelector('.user-name'); // Changed from welcomeName
                
                // Set welcome name
                userName.textContent = `${firstName} ${lastName}`; // Using the correct class
                ...
                showError(signupForm.querySelector('input'), 'Signup failed. Please try again.');
            } finally {
                submitBtn.classList.remove('loading');
            }
        });
